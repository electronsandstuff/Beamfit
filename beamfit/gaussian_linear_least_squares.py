...
def x_to_h_grad(x):
    ...
    j[0, 2] = -(-1 * x[3] * x[4] + 2 * x[1] * x[5]) / (x[4] ** 2 - 4 * x[2] * x[5]) ** 2 * (- 4 * x[5])
    j[0, 3] = (-1 * x[4]) / (x[4] ** 2 - 4 * x[2] * x[5])
    j[0, 4] = (-1 * x[3]) / (x[4] ** 2 - 4 * x[2] * x[5]) \
              - (-1 * x[3] * x[4] + 2 * x[1] * x[5]) / (x[4] ** 2 - 4 * x[2] * x[5]) ** 2 * x[4] * 2
    j[0, 5] = (2 * x[1]) / (x[4] ** 2 - 4 * x[2] * x[5]) \
              - (-1 * x[3] * x[4] + 2 * x[1] * x[5]) / (x[4] ** 2 - 4 * x[2] * x[5]) ** 2 * (- 4 * x[2])
    j[1, 1] = (x[4]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5])
    j[1, 2] = (-2 * x[3]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5]) \
              - (-2 * x[2] * x[3] + x[1] * x[4]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5]) ** 2 * (4 * x[5])
    j[1, 3] = (-2 * x[2]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5])
    j[1, 4] = (x[1]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5]) \
              - (-2 * x[2] * x[3] + x[1] * x[4]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5]) ** 2 * (-2 * x[4])
    j[1, 5] = -(-2 * x[2] * x[3] + x[1] * x[4]) / (-1 * x[4] ** 2 + 4 * x[2] * x[5]) ** 2 * (4 * x[2])
    j[2, 2] = 2 * x[5] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * x[5]/4
    j[2, 4] = 2 * x[5] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * (-2 * x[4])/4/4
    j[2, 5] = -2 / (x[2] * x[5] - x[4] ** 2/4)/4 + 2 * x[5] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * x[2]/4
    j[3, 2] = -x[4] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * x[5]/4
    j[3, 4] = 1 / (x[2] * x[5] - x[4] ** 2/4)/4 - x[4] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * (-2) * x[4]/4/4
    j[3, 5] = -x[4] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * x[2]/4
    j[4, 2] = -2 / (x[2] * x[5] - x[4] ** 2/4)/4 + 2 * x[2] / (x[2] * x[5] - x[4] ** 2/4) ** 2 * x[5]/4
